...
| `agregar_freno_y_desglose_reproceso.sql` (etapa 2 de "elegir del stock que hay": la tabla `operarios_deposito` para el selector, la marca del reparto declarado por el operario, y el motivo + operario de la excepción al freno) | ⬜ pendiente (verificador: 9/9) | ⬜ pendiente (verificador: 9/9) |
